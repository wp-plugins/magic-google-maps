...
Add Google maps quickly and easily to your page. Magic Goole maps is light weight plugin optimised for speed. Add Google map toy your page with shortcode [map].
...
* Small changes in the syntax

= 1.0.0 =
*First release Magic Google Maps
